            ...
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item label="供应商" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-select placeholder="请选择供应商" showSearch allowClear
        ...
        <a-table
          ...
          <template slot="paidSlot" slot-scope="text, record">
            <a-switch
              ...
              checkedChildren="已付" unCheckedChildren="未付" />
          </template>
          ...
          <template slot="action" slot-scope="text, record">
            ...
            <a-tooltip v-else title="已付款或已开票的对账单不能编辑删除">
              <span style="color: #ccc;">编辑</span>
            </a-tooltip>
          </template>
        </a-table>
        <supplier-reconciliation-create-modal ref="createModal" @ok="loadData"/>
...
export default {
  ...
  components: {
    ...
    SupplierReconciliationCreateModal,
    ...
    handleTogglePaid(record) {
      ...
      axios.put('/reconciliation/updateStatus', params).then(res => {
        if (res && res.code === 200) {
          ...
          this.$message.success(newPaid === 1 ? '已标记为已付款' : '已取消付款标记')
        } else {
