...
* **仓库地址：https://github.com/LSJice/jsherp** （原上游：https://github.com/jishenghua/jshERP）

# 新增功能
## 供应商/客户对账管理
* 支持供应商对账单和客户对账单的创建、编辑、删除
* 对账预览：按时间段和订单状态筛选入库/出库明细，自动汇总金额
* 付款/开票状态管理：标记已付款、编辑发票信息
* 对账明细导出：支持导出Excel格式的对账明细
* 订单对账状态联动：对账后自动更新订单的对账状态，防止重复对账
